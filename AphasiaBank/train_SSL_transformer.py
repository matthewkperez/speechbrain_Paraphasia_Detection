...
def vocab_check(save_folder_tokenizer, hparams):
    ...
    tokenizer2 = SentencePiece(
        model_dir=hparams["pretrained_lm_tokenizer_path"],
    ...
    print("Vocabs for LM and save_output are identical")
...
if __name__ == "__main__":
    ...
    print(f"best_ctc: {best_ctc} | best_lm: {best_lm}")
    ...
    print(f"EVALUATE best test_search params lm: {best_lm} | ctc: {best_ctc}")
